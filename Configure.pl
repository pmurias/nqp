...
my %known_backends = (parrot => 'p', jvm => 'j', moar => 'm', js => 'js');
...
MAIN: {
    ...
    my @prefixes = sort map { $known_backends{$_} } keys %backends;
    print $MAKEFILE "\n# Makefile code generated by Configure.pl:\n";

    my $launcher = $known_backends{$default_backend} . '-runner-default';
